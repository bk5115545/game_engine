...
bool App2D::Initialize(SDLRenderer* renderer,
    ...
    component_factories_->AddFactory("Animation", static_cast<ComponentFactory*>(new AnimationFactory()));
    ...
    component_factories_->AddFactory("Player", static_cast<ComponentFactory*>(new PlayerFactory(input_device_)));
    // component_factories_->AddFactory("RigidCircle", reinterpret_cast<ComponentFactory*>new RigidCircleFactory(world_));
    component_factories_->AddFactory("RigidRectangle", static_cast<ComponentFactory*>(new RigidRectangleFactory(world_)));
    component_factories_->AddFactory("Sprite", static_cast<ComponentFactory*>(new SpriteFactory(renderer_, art_library_)));
