...
Player* PlayerFactory::Create(Actor2D* owner, pugi::xml_node node) {
    UNUSED(node);
...
RigidRectangle* RigidRectangleFactory::Create(Actor2D* owner,
                                              pugi::xml_node node) {
...
// SpriteFactory stuff
SpriteFactory::SpriteFactory(SDLRenderer* renderer,
...
Sprite* SpriteFactory::Create(Actor2D* owner,
                              pugi::xml_node node) {
...
Animation* AnimationFactory::Create(Actor2D* owner,
                                    pugi::xml_node node) {
